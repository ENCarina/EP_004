...
8.  [Egyéb információk és Mellékletek](#8-egyéb-információk-és-mellékletek)
...
### 5.2.5. A minőségbiztosítási folyamat záró értékelése
...
A stressz teszt során a rendszer teherbírását és a szélsőséges terhelés melletti stabilitását vizsgáltuk, különös tekintettel a kliensoldali megjelenítés folyamatosságára és az adatbázis-műveletek biztonságára.

### 5.5.1. Nagytömegű adatkezelés
A teszt ezen fázisában a rendszer válaszkészségét elemeztük az átlagos felhasználást jelentősen meghaladó adatmennyiség mellett. Mesterségesen generált szabad idősávokkal és nagyszámú regisztrált pácienssel figyeltük meg a naptárkomponens és az adatlekérdezések viselkedését.

* **Tapasztalat:** Az Angular-alapú naptár nézet a megnövelt adatmennyiség ellenére is megőrizte reszponzivitását; a felületi elemek görgetése és a szűrések folyamatosak maradtak. 
* **Eredmény:** Az API végpontok stabilan szolgálták ki a kéréseket, a válaszidőkben nem volt tapasztalható a felhasználói élményt rontó késleltetés, ami igazolja a frontend és a backend hatékony együttműködését.

### 5.5.2. Párhuzamos terhelés és erőforrás-kezelés
A vizsgálat során a párhuzamosan érkező kérések és az egyidejű adatbázis-műveletek hatását elemeztük a rendszer integritására.

* **Sajátosság:** A fájlalapú SQLite adatbázis technológiai jellemzőiből adódóan az intenzív, egyidejű írási műveletek során a tranzakciók sorba rendezése figyelhető meg. Rendkívül magas párhuzamos kérésszám esetén a rendszer eléri az adatbázis-zárolási küszöböt.
* **Reakció:** A rendszer váratlan leállás vagy fagyás nélkül kezelte a kritikus terhelést. A szerveroldali hibaüzenet-kezelés megfelelően működött: az adatbázis ideiglenes elérésekor fellépő zárolási eseményeket a szoftver naplózta.
* **Felhasználói élmény:** A felhasználók tájékoztatást kaptak a művelet későbbi megismétlésének szükségességéről. Ez a megközelítés garantálja az adatsérülések elkerülését és a rendszer konzisztenciájának megőrzését még kényszerített terhelés mellett is.
...
| :--- | :--- | :--- | :--- |
| **TC-01** | Regisztráció és aktiválás | Valid adatokkal a fiók létrejön és aktiválható. | **PASSED** |
| **TC-03** | Időpontfoglalási folyamat | A kiválasztott slot foglalttá válik, a naptár frissül. | **PASSED** |
| **TC-04** | Form validáció | Helytelen adatoknál azonnali, magyar nyelvű hibaüzenet. | **PASSED** |
| **TC-05** | Mobil reszponzivitás | A menü és a kártyák mobilon is kényelmesen kezelhetők. | **PASSED** |
...
## 8. Egyéb információk és Mellékletek
...
| **P_07.6** | **Integrált navigáció** | Kiválasztott konzultáció ID | A szolgáltatás kiválasztása után a rendszer átirányít a foglalási felületre, továbbítva a szükséges paramétereket. | A router navigáció pontos, a foglalási folyamat zökkenőmentesen folytatódik a kiválasztott elemmel. | **PASSED** |
...
> **Megjegyzés a struktúrához:** A **P_11. Fiókaktiválás folyamat ellenőrzése** teszteset beolvadt a **P_01** fejezetbe. A dokumentáció egységesítése érdekében a témakörök szerinti rendezést követtem, így a folyamat részletezése és eredményei a **P_01.2** pont alatt találhatóak.
...
### 8.2 Manuális Teszt esetek eredményeiről néhány példa, bizonyítékok 

| | |
| :--- | :--- |
| ![P_01.4 Foglalt email](./screenshots/P_01_4.png) | ![P_01.10 Email megerősítés szükséges](./screenshots/P_01_10.png) |
| **P_01.4 Már létező email cím** | **P_01.10 Email megerősítés (Verify)** |
| | |
| ![P_05.8 Admin felülbírálás](./screenshots/P_05_8.png) | ![P_06.6 Angol pdf report fejléce](./screenshots/P_06_6.png) |
| **P_05.8 Admin 24h felülbírálás** | **P_06.6 Nyelvspecifikus riportálás** |
| | |
| ![P_10.7 Ütköző foglalás tiltása](./screenshots/P_10_7.png) | ![P_10.8 Foglalás lemondás](./screenshots/P_10_8.png) |
| **P_10.7 Ütköző foglalás tiltása (Race Condition)** | **P_10.8 Lemondás és felszabadítás (>24h)** |
...
* **Node.js v24 Documentation (2025):** *Szerveroldali futtatókörnyezet specifikáció.* Elérhetőség: [https://nodejs.org/docs](https://nodejs.org/docs) (Utolsó megtekintés: 2026.02.10.)
* **Sequelize ORM (2024):** *Node.js Object-Relational Mapping dokumentáció.* Elérhetőség: [https://sequelize.org](https://sequelize.org) (Utolsó megtekintés: 2026.01.25.)
* **SQLite Documentation (2024):** *Relációs adatbázis motor specifikáció és SQL szintaxis.* Elérhetőség: [https://www.sqlite.org/docs.html](https://www.sqlite.org/docs.html) (Utolsó megtekintés: 2026.02.30.)
